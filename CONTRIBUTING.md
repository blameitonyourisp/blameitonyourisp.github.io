...
If you encounter an issue whilst using this repository or any software released by it, please submit an issue using the [issue tracker for this repository](https://github.com/blameitonyourisp/blameitonyourisp.github.io/issues). Issues for this repository are tracked using the default [github](https://github.com) issue tracker ([see here](https://docs.github.com/en/issues/tracking-your-work-with-issues) for more information on managing repository issues on [github](https://github.com)).
...
| `build:dev`       | Run `start:web` script.                                                                                                         |
| `build:dist`      | Output production build of repository static demo site to `./dist` directory.                                                   |
...
| `test`            | Run available tests for repository static site.                                                                            |
| `types`         | Check types using `tsc`                                                                                                         |
